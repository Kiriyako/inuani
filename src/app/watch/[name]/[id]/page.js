  ...
  useEffect(() => {
    ...
    const newPlayer = Player.make("#app", {
      ...
      ui({
        ...
        icons: {
          play: `<svg viewBox='0 0 24 24'><polygon points='5 3 19 12 5 21 5 3' fill='#fff'/></svg>`,
          pause: `<svg viewBox='0 0 24 24'><rect width='4' height='16' x='6' y='4' fill='#fff'/><rect width='4' height='16' x='14' y='4' fill='#fff'/></svg>`,
          volume: [
            `<svg viewBox='0 0 24 24'><polygon points='11 5 6 9 2 9 2 15 6 15 11 19 11 5' fill='#fff'/></svg>`,
            `<svg viewBox='0 0 24 24'><line x1='22' x2='16' y1='9' y2='15' stroke='#fff'/><line x1='16' x2='22' y1='9' y2='15' stroke='#fff'/></svg>`
          ],
        },
      }),
      hls({ forceHLS: true }),
